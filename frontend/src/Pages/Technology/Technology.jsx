      ...
      <Grid container>
        ...
        >
          <Typography variant="body1" sx={{ textAlign: "center" }}>
            ...
            and skilled team is efficient in fulfilling the unique requirements
            of clients by complying with the recent industry standards. We work
            in some major areas of technical application to let business develop
              ...
              >
                ...
                <CardContent>
                  ...
                  >
                    ...
                    Node.js works with a variety of operating systems, including
                    Windows, Linux, Unix, and macOS. JavaScript code can be
                    executed outside of a web browser with Node.js, a back-end
                    JavaScript runtime environment that is powered by the V8
                    JavaScript engine.
                  </Typography>
                </CardContent>
              </Card>
              ...
              >
                ...
                <CardContent>
                  ...
                  >
                    ...
                    sometimes shortened to JS. JavaScript is used on the client
                    side by 98.7% of websites as of 2023 to control webpage
                    behavior, frequently integrating third-party libraries
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={3} lg={3}>
              ...
              >
                ...
                <CardContent>
                  ...
                  >
                    Blazor is a web framework developed by Microsoft that allows
                    developers to build interactive web applications using C#
                    and .NET instead of relying on traditional web development
                    technologies like JavaScript, HTML, and CSS. Blazor enables
                    developers to use C# on the client-side to build web
                    applications, which was traditionally the domain of
                    JavaScript.
                  </Typography>
                </CardContent>
              </Card>
              ...
              >
                ...
                <CardContent>
                  ...
                  >
                    ...
                    popular React UI framework that implements Google's Material
                    Design principles. Material-UI provides a set of React
                    components that follow the Material Design guidelines,
                    offering a consistent and visually appealing design language
            ...
            <Grid item xs={12} sm={6} md={3} lg={3}>
              ...
              >
                ...
                <CardContent>
                  ...
                  >
                    A database is a structured collection of data organized in a
                    way that a computer program can quickly select and retrieve
                    specific pieces of data. Databases can be used to store,
                    manage, and retrieve information efficiently.Different types
                    of databases exist, including relational databases, NoSQL
                    databases
                  </Typography>
                </CardContent>
              </Card>
              ...
              >
                ...
                <CardContent>
                  ...
                  >
                    ...
                    businesses manage their IT resources and deliver services to
                    users.
                  </Typography>
                </CardContent>
              </Card>
            ...
            <Grid item xs={12} sm={6} md={3} lg={3}>
              ...
              >
                ...
                <CardContent>
                  ...
                  >
                    Prototype tools are software applications or platforms that
                    facilitate the creation of interactive prototypes for user
                    interfaces and experiences. Prototyping is a crucial step in
                    the design and development process, allowing designers and
                    developers to visualize, test, and refine their ideas before
              ...
              >
                ...
                <CardContent>
                  ...
                  >
                    ...
                    platform for building client-side applications, particularly
                    single-page applications (SPAs).Angular is part of the MEAN
                    and MERN stacks, which are popular for building modern,
            ...
            <Grid item xs={12} sm={6} md={3} lg={3}>
              ...
              >
                ...
                <CardContent>
                  ...
                  >
                    Manual API testing involves manually sending requests to an
                    application's interface and verifying the responses, while
                    automated API testing utilizes specialized software tools to
                    send requests and validate responses.Manual Testing needs
                    time when testing is needed at a large scale.
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
